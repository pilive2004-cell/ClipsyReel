...
const COPY = {
  ...
  zh: {
    ...
    render: { editing: "正在编辑你的蒙太奇…", processingRoute: "正在准备动态路线地图…", processingGear: "正在准备装备总结卡片…", processingCuts: "正在剪切、缩放并交叉淡化片段…", loading: "正在加载剪辑引擎…", retry: "重试", continueRaw: "继续使用原始片段", error: "此设备无法渲染该蒙太奇。你可以重试，或继续使用原始片段。" },
